import sys
sys.path.append("D:\\Huflit\\ANHTTT Huflit\\2023-2024\\detai\\Control")
...
class SignupDialog(QDialog, Ui_Dialog):
    ...
    def check_signup(self):
        ...
        if(self.password != password2):
            ...
            with open("D:\\Huflit\\ANHTTT Huflit\\2023-2024\\detai\\Data\\account.txt", "a", encoding='utf-8') as file:
                file.write(us+","+ps+"\n")
            self.close()
